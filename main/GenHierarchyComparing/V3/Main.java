...
public class Main {
    public static void main(String... args) {
        ...
        if (one instanceof One<?>) System.out.println("ArgumentClass - one: " +  true);
        if (one instanceof Two<?>) System.out.println("Two - one: " +  true);
        if (two instanceof One<?>) System.out.println("ArgumentClass - two: " +  true);
        if (two instanceof Two<?>) System.out.println("Two - two: " +  true);
        if (three instanceof One<?>) System.out.println("ArgumentClass - three: " +  true);
